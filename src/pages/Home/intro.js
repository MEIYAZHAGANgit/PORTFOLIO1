...
function Intro() {
  return (
    ...
    <p className="text-white"> "Hi, I'm an enthusiastic MERN stack developer with a strong foundation in MongoDB, Express.js, React.js, and Node.js. <br/>As a recent graduate, I am eager to apply my skills and knowledge to contribute effectively to web development projects.</p>
